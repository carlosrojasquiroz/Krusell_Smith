...
p.Kmin=3; % low level for the mean of aggregate capital
p.Kmax=7; % max level for the mean of aggregate capital
...
p.disp1=0; % disp=1, displays the tolerance error and the time to execute the EGM
